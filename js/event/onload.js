...
function onloadJyankenEvent() {
    ...
    ELM_area_anime_a = document.getElementById(AREA_ANM_IMG_A);
    ELM_area_anime_b = document.getElementById(AREA_ANM_IMG_B);
    ELM_area_anime_c = document.getElementById(AREA_ANM_IMG_C);
    ELM_area_anime_d = document.getElementById(AREA_ANM_IMG_D);
